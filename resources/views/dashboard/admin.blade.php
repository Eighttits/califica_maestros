<x-app-layout>
    ...
    <div class="flex justify-end mr-4 mb-4 mt-3">
        <a href="{{ route('add-student') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrar alumno</a>
